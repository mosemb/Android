package com.hfad.sunshinelayouts.utilities;

import android.content.Context;
import android.util.Log;

import com.hfad.sunshinelayouts.R;
import com.hfad.sunshinelayouts.data.SunshinePrefrences;
...
public class SunshineWeatherUtils {
    ...
    public static String formatTemperature(Context context, double temperature) {
        ...
        if (!SunshinePrefrences.isMetric(context)) {
